...
public class GmailApiService : BackgroundService
{
    ...
    public GmailApiService(IServiceProvider serviceProvider, ILogger<GmailApiService> logger)
    {
        ...
        CancellationToken ct = default)
    {
        ...
        var ourMessageId = $"<ss-{ticketId}-{Guid.NewGuid():N}@servicesphere.local>";
        ...
        // Record outbound email for threading
        var ticketEmail = new TicketEmail
        {
            TicketId = ticketId,
