...
(function($) {
    ...
    themeDirectionSelect.on('change', function() {
        ...
        if(html.attr('dir') === "rtl"){
			jQuery('.main-css').attr('href','../Jobick/css/style-rtl.css');
		}else{
            jQuery('.main-css').attr('href','../Jobick/css/style.css')
		}
